...
# ========= USER PARAMS =========
SDF_PATH      = "potentials/potential10.npz"   # your φ (signed distance) NPZ (from png_to_sdf)
OUT_DIR       = "eigensdf/doublewell/potential10/trial1"           # new output directory (do NOT reuse old one)
E_CUT         = 3                          # collect all modes with E <= E_CUT
N_TARGET      = 5000                          # or set e.g. 12000 to stop at count instead of E_CUT
...
SAVE_THIN     = 500                          # flush to disk every this many NEW modes
# =================================
