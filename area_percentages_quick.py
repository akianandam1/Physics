...
CONFIG = {
    ...
    "NPZ_PATH": r"potentials/potential8.npz",
    "LABEL_PNG": r"potentials/labeled_potential8.png",# if manual_label_png: 0 bg, 1 small, 2 channel, 3 large (or pure RGB)
    "CHANNEL_RADIUS": 9.0,               # for component_split only

    "OUT_DIR": r"eigensdf/doublewell/trial2",
