...
# ========= USER PARAMS =========
OUT_DIR         = "eigensdf/doublewell/potential10/trial1"                      # where your store lives
OUTPUT_DIR = "eigensdf/doublewell/potential10/trial1/renders"                    # where we output images
SDF_PATH        = "potentials/potential10sdf.npz"     # fallback if geometry_used.npz not present
...
h5_path = os.path.join(OUT_DIR, "eigenpairs.h5")
